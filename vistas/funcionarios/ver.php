...
<body>
    ...
    <div class="main-content">
        <?php 
        $pageTitle = $nivel_acceso >= 3 ? Icon::get('user') . ' Mi Expediente' : Icon::get('user') . ' Expediente Digital';
        // The header.php handles the title. The back button will be put below.
